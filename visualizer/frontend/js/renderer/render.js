...
export function loadCanvas(canvasid){
    ...
    // Setup the camera
    const width = canvas_dom_obj.clientWidth;
    const height = canvas_dom_obj.clientHeight;
    const aspect = (width/height >= 1)? width/height : height/width;
    const cameraid = rendererObj.addCamera(75, aspect , 0.1, 100, [-6, 3, 0],  [0,0,0]);
    ...
    function animate(time){
        rendererObj.updateAspectRatio(cameraid);
